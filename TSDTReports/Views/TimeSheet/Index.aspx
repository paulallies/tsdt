...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="overflow: scroll; padding: 5px;">
        <table class="Control" id="tblTimeSheets" style="background-color: white; width: 2200px;
            ...
            <tr>
                <td>
                    ...
                    <a href="<%=HttpRuntime.AppDomainAppVirtualPath.TrimEnd('/') %>/Timesheet/edit/<%=Html.Encode(ts.Resource_ID) %>/Date/<%=Html.Encode(Model.Date.ToString("dd-MMM-yyyy")) %>/User/<%=Html.Encode(Model.User_CAI.ToString()) %>">
                        <img src="<%=HttpRuntime.AppDomainAppVirtualPath.TrimEnd('/') %>/images/edit-16x16.png"
    ...
    <div id="popupContact" style="overflow: scroll; padding: 5px;">
        <table class="Control" style="background-color: white; border-collapse: collapse;"
            ...
            <tr>
                <td>
                    <%=Html.CheckBox("chk" + item.Resource_ID, item.Hide)%></td>
                <td>
                    <%=Html.Encode(item.tbl_Project.Project_Number.ToString())%></td>
                <td>
                    <%=Html.Encode(item.tbl_Project.WBS)%></td>
                <td>
                    <%=Html.Encode(item.tbl_Project.Project_Name)%></td>
            </tr>
            <%} %>
        </table>
