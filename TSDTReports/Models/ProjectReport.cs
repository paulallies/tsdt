...
{
    public class ProjectReport : IPDFReport
    {
        ...
        public  ProjectReport(bool Landscape)
        {
        ...
        private void RenderReportJobInfo()
        {
            ...
            JobInfotable.AddCell(new Phrase("Report", fntHeading));
            JobInfotable.AddCell(new Phrase("Project Report", fntDetails));
